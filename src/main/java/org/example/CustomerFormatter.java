...
public class CustomerFormatter {
    ...
    public static String formatCustomer(Customer c){
        return c.getName() + DELIMITTER + c.getAdress() + DELIMITTER + c.getCity() + DELIMITTER + c.getZip() + DELIMITTER + c.getBirthday() + DELIMITTER + c.getEmail() + DELIMITTER + c.getPhoneNumber() + DELIMITTER + c.getPassword();
    }
